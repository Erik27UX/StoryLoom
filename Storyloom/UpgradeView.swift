                ...
                VStack(alignment: .leading, spacing: 28) {
                    ...
                    VStack(spacing: 12) {
                        Button(action: {
                            ...
                            #if DEBUG
                            // DEV ONLY — applies the tier immediately without payment.
                            // In production builds this path is unreachable; real
                            // StoreKit purchases will be wired up here before launch.
                            let tier: SubscriptionTier = selectedPlan == "family" ? .family : .premium
